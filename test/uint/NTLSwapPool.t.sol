...
contract NTLSwapPoolTest is Test {
    ...
    function test_withdraw() public {
        ...
        uint256 wethToWithdraw =
            (20e18 * weth.balanceOf(address(pool))) / pool.totalLiquidityTokenSupply();
        uint256 poolTokensToWithdraw =
            (20e18 * poolToken.balanceOf(address(pool))) / pool.totalLiquidityTokenSupply();
        console.log(wethToWithdraw,poolTokensToWithdraw);
         pool.withdraw(20e18, 10e18, 10e18, uint64(block.timestamp));
        assertEq(weth.balanceOf(liquidityProvider), 120e18);
    }
}
