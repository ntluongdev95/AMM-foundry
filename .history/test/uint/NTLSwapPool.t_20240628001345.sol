...
contract NTLSwapPoolTest is Test {
    ...
    function test_withdraw() public {
        ...
        vm.stopPrank();
        vm.startPrank(liquidityProvider);
        uint x =weth.balanceOf(address(this));
        uint y = poolToken.balanceOf(address(this));
        
        uint256 wethToWithdraw =
            (20e18 * weth.balanceOf(address(this))) / pool.totalLiquidityTokenSupply();
        uint256 poolTokensToWithdraw =
            (20e18 * poolToken.balanceOf(address(this))) / pool.totalLiquidityTokenSupply();
        console.log(wethToWithdraw,poolTokensToWithdraw);
        // pool.withdraw(1, 100e18, 100e18, uint64(block.timestamp));
    }
}
