...
contract NTLSwapPoolTest is Test {
    ...
    function test_RevertWethDepositAmountTooLow ()public{
        vm.startPrank(liquidityProvider);
        vm.expectRevert(NTLSwapPool.NTLSwapPool__WethDepositAmountTooLow.selector);
        weth.approve(address(pool),1_000_000_00);
        poolToken.approve(address(pool), 100e18);
        pool.deposit(1_000_000_00, 100e18, 100e18, uint64(block.timestamp));
    }
