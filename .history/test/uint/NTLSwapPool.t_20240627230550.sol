...
contract NTLSwapPoolTest is Test {
    ...
    function test_DepositWithExistingLiquidity () public{
        ...
        uint256 totalLiquidityTokenSupply = pool.totalLiquidityTokenSupply();
        uint256 liquidityTokensToMint = (5e18 * totalLiquidityTokenSupply) // 100e18;
          console.log(totalLiquidityTokenSupply); //100e18
        ...
        pool.deposit(100e18, 5e18, 10e18, uint64(block.timestamp));
