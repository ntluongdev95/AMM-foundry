...
contract NTLSwapPoolTest is Test {
    ...
    function test_revertIfDeadlinePassed ()public{
        ...
        weth.approve(address(pool), 100e18);
        poolToken.approve(address(pool), 100e18);
        pool.deposit(100e18, 100e18, 100e18, uint64(block.timestamp +50));
        vm.stopPrank();
        vm.startPrank(liquidityProvider);
        vm.expectRevert(NTLSwapPool.NTLSwapPool__DeadlineHasPassed.selector);
        pool.withdraw(100e18, 100e18,10e18, uint64(block.timestamp +50));
    }
